...
public class VoucherController {
    ...
    public void getAll(Request req, Response res) {
        try {
            ...
            res.setStatus(500);
            res.send("{\"error\":\"Failed to fetch vouchers\"}");
        }
    }
    ...
    public void getById(Request req, Response res) {
        try {
            ...
            res.setStatus(500);
            res.send("{\"error\":\"Failed to fetch voucher by ID\"}");
        }
    }
    ...
    public void create(Request req, Response res) {
        try {
            ...
            res.setStatus(500);
            res.send("{\"error\":\"Failed to create voucher\"}");
        }
    }
    ...
    public void update(Request req, Response res) {
        try {
            ...
            res.setStatus(500);
            res.send("{\"error\":\"Failed to update voucher\"}");
        }
    }
    ...
    public void delete(Request req, Response res) {
        try {
            ...
            res.setStatus(500);
            res.send("{\"error\":\"Failed to delete voucher\"}");
        }
    }
}
